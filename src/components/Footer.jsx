...
const Footer = () => {
  return (
    <>
      <div className="m-16">
        <hr className="w-[75%] mx-auto border-t-2 bg-gray-800" />
        <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-2 gap-25">
          ...
          <div className="lg:col-span-2 flex flex-wrap justify-between mt-6">
            ...
            <div>
              <h6 className="font-medium text-orange-600 mt-5 ">Local Services</h6>
              <ul>
                <li className="pt-3 text-sm hover:text-[#ff7f50] hover:cursor-pointer transition-all duration-300 ease-in-out hover:scale-105">Influencer Marketing USA</li>
                <li className="pt-3 text-sm hover:text-[#ff7f50] hover:cursor-pointer transition-all duration-300 ease-in-out hover:scale-105">Paid Media Agency USA</li>
                <li className="pt-3 text-sm hover:text-[#ff7f50] hover:cursor-pointer transition-all duration-300 ease-in-out hover:scale-105">Influencer Marketing Agency UK</li>
                <li className="pt-3 text-sm hover:text-[#ff7f50] hover:cursor-pointer transition-all duration-300 ease-in-out hover:scale-105">Paid Media Agency UK</li>
              </ul>
            </div>
            <div>
        ...
        <div className="flex flex-col md:flex-row gap-20" >
          ...
          <div className="hidden sm:flex bg-gradient-to-r from-orange-600 via-orange-300 to-orange-500 rounded-md w-fit p-4 justify-between gap-6">
            ...
            <div className="bg-gray-800 text-white border-2 inline-block w-[35%] my-auto px-2 py-3">LEARN MORE {">"}</div>
          </div>
